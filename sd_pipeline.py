...
class StableDiffusionGenerate:
    ...
    def from_default(cls):
        ...
        SAVE_HDR_PATH = "output/hdr/sd_hdr.png"
    ...
    def save_hdr(self, contrast=1.0, brightness=0.0):
        ...
        alpha = cv2.convertScaleAbs(alpha, alpha=contrast, beta=brightness)
